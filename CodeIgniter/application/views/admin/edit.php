							...
							<tr>
								...
								<td class="new_value">
									<div class="form-group">
										...
										<input type="text"
											   class="form-control" value="<?=$value['Name']; ?>" name="Name" id="" aria-describedby="helpId" placeholder="Product name">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="new_value">
									<div class="form-group">
										...
										<input type="text"
											   class="form-control" value="<?=$value['Size']; ?>" name="Size" id="" aria-describedby="helpId" placeholder="Sizes">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="new_value">
									<div class="form-group">
										...
										<input type="text"
											   class="form-control" value="<?=$value['Color']; ?>" name="Color" id="" aria-describedby="helpId" placeholder="Colors">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="new_value">
									<div class="form-group">
										...
										<input type="text"
											   class="form-control" value="<?=$value['Material']; ?>" name="Material" id="" aria-describedby="helpId" placeholder="Materials">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="new_value">
									<div class="form-group">
										<label for="new material"></label>
										<input type="text"
											   class="form-control" value="<?=$value['Description']; ?>" name="Description" id="" aria-describedby="helpId" placeholder="Description">
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="new_value">
									<div class="form-group">
										...
										<input type="text"
											   class="form-control" value="<?=$value['Origin']; ?>" name="Origin" id="" aria-describedby="helpId" placeholder="Origin">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="new_value">
									<div class="form-group">
										<label for="avatar">
											...
											<input type="type"
												   class="form-control" name="File" id="image" aria-describedby="helpId" value="<?=$value['File']?>" style="margin-top: 15px; width:130%;">
										</label>
										<div style="width: 150px; height: 150px">
											<img src="<?=$value['File']?>" style="max-width: 100%; max-height: 100%; width: auto">
										</div>
									</div>
								</td>
							</tr>
