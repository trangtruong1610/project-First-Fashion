...
<div class="debug container-fluid wrap">
	<div class="row" style="margin-bottom: 50px; height: 40em;">
		<!--product images-->
		<div class="col-md-6 col-sm-4 row debug">
			...
			<div class="img-sub col-md-3 debug"  id="product-scrollbar" style="overflow: scroll; height: 30em; width: 100%; text-align: center;">
