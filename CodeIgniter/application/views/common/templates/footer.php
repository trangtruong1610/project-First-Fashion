        ...
        <div class="debug col-lg-4 row">
                ...
                <div>
                    <ul class="list-lev1">
                        <li class="list-lev2 debug">
                            <a href="<?=base_url().'product/accessories'?>" class="debug list-lev1-item">
                                Accessories
                            </a>
                        </li>
                        <li class="list-lev2 debug">
                            <a href="<?=base_url().'product/children'?>" class="debug list-lev1-item">
                                Children
                            </a>
                        </li>
                        <li class="list-lev2 debug">
                            <a href="<?=base_url().'product/fashion'?>" class="debug list-lev1-item">
                                Fashion
                            </a>
                        </li>
                    </ul>
            ...
            <div class="debug col-sm-6">
                ...
                <div>
                    <ul class="list-lev1">
                        <li class="list-lev2">
                            <a href="<?=base_url()?>" class="debug list-lev1-item">
                                Our Brands
                            </a>
                        </li>
                        <li class="list-lev2">
