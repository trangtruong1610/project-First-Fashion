...
<div class="container-fluid debug">
	<?php foreach(array_chunk($product, 3) as $row_data_break) :?>
		...
		<div class="col-md-4 col-sm-6">
			<div class="card h-100">
				<div style="height: 300px; text-align: center; padding: 10px">
					<img align="middle" class="card-img-top" src="<?=$row['Link']?>" alt="<?=$row['ProductName']?>" style="max-height:100%; max-width: 100%; width: auto; position: relative; top: 50%; transform: translateY(-50%);">
				</div>
				<div class="card-body">
					<h4 class="card-title"><?=$row['ProductName']?></h4>
					<p class="card-text"><?=$row['ListPrice']?></p>
				</div>
				<div class="card-footer text-muted" style="text-align: center;">
					<a name="details" id="p_detail" class="btn btn-dark" href="#" role="button">Details <i class="fas fa-search" style="margin-left: 5px; font-size: 12px;" aria-hidden="true"></i></a>
