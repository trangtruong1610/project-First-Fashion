...
# Generation Time: 2020-01-12 10:21:06 +0000
# ************************************************************
...
INSERT INTO `category` (`id`, `CategoryName`, `parent_id`, `CategoryType`)
VALUES
	(1,'fashion',NULL,NULL),
...
INSERT INTO `file` (`product_id`, `File_id`, `File_Type`, `Link`, `File_role`, `status`)
VALUES
	(1,1,'image','https://www.imageupload.net/upload-image/2019/12/30/14090581_22480959_1000.jpg','p_demo','1'),
	...
	(2,5,'image','https://www.imageupload.net/upload-image/2019/12/30/14229690_20141914_1000.jpg','p_demo','1'),
	...
	(3,9,'image','https://www.imageupload.net/upload-image/2019/12/30/14516838_23027721_1000.png','p_demo','1'),
	...
	(4,13,'image','https://www.imageupload.net/upload-image/2019/12/30/12606171_12109880_1000-1.png','p_demo','1'),
	...
	(5,17,'image','https://www.imageupload.net/upload-image/2019/12/30/13611915_22000685_1000.jpg','p_demo','1'),
	...
	(9,33,'image','https://www.imageupload.net/upload-image/2019/12/30/14229690_20141924_10004ef114e7778b2569.jpg','p_demo','1'),
	...
	(10,37,'image','https://www.imageupload.net/upload-image/2019/12/30/12870974-1-racingred.jpg','p_demo','1'),
	...
	(11,41,'image','https://www.imageupload.net/upload-image/2019/12/30/11055311-1-dfwhite.jpg','p_demo','1'),
	...
	(12,45,'image','https://www.imageupload.net/upload-image/2019/12/30/hugo-boss-men_s-medium-gray-crosstown-grainy-briefcase-50390384_030.jpg','p_demo','1'),
	...
	(13,49,'image','https://www.imageupload.net/upload-image/2019/12/31/716btntoj5L._UL1500_.jpg','p_demo','1'),
	(13,50,'image','https://www.imageupload.net/upload-image/2019/12/31/ezgif.com-webp-to-jpg589d5ddfd67241b7.jpg','p_demo','1'),
	(14,51,'image','https://www.imageupload.net/upload-image/2019/12/30/14032866_18392426_1000.png','p_demo','1'),
	...
	(15,55,'image','https://www.imageupload.net/upload-image/2019/12/30/jackets-gucci.jpg','p_demo','1'),
	...
	(17,58,'image','https://www.imageupload.net/upload-image/2019/12/31/acne-studios-ellison-face-tshirt-paprika-red-face-patch-at-breast-solid-color-design-1069-500x500.jpg','p_demo','1'),
	...
	(18,62,'image','https://www.imageupload.net/upload-image/2019/12/31/13613105-1-navy.jpg','p_demo','1'),
	...
	(19,65,'image','https://www.imageupload.net/upload-image/2019/12/31/201418M175002_1.jpg','p_demo','1'),
	...
	(20,70,'image','https://www.imageupload.net/upload-image/2019/12/31/adidas-design-2-move-climacool-3-stripes-knit-shorts-regular.jpg','p_demo','1'),
	...
	(21,73,'image','https://www.imageupload.net/upload-image/2019/12/31/13903653_17736912_1000.jpg','p_demo','1'),
	...
	(22,77,'image','https://www.imageupload.net/upload-image/2019/12/31/71VYxA3casL._UX679_.jpg','p_demo','1'),
	...
	(23,80,'image','https://www.imageupload.net/upload-image/2019/12/31/9816402.jpg','p_demo','1'),
	...
	(24,83,'image','https://www.imageupload.net/upload-image/2019/12/31/BLOW-WB30_V1-1.jpg','p_demo','1'),
	...
	(25,86,'image','https://www.imageupload.net/upload-image/2019/12/31/Adidas_PU-9.jpg','p_demo','1'),
	...
	(26,89,'image','https://www.imageupload.net/upload-image/2019/12/31/008_a41a66da-079c-431c-82c1-b7e13117e8d0.jpg','p_demo','1'),
	(26,90,'image','https://www.imageupload.net/upload-image/2019/12/31/66448100.jpg','p_demo','1'),
	(27,91,'image','https://www.imageupload.net/upload-image/2019/12/31/8994938-1-grey.jpg','p_demo','1'),
	...
	(28,94,'image','https://www.imageupload.net/upload-image/2019/12/31/12846552_xxl_v1572924596501.jpg','p_demo','1'),
	...
	(29,97,'image','https://www.imageupload.net/upload-image/2019/12/31/411H6t6lNgL._UY445_.jpg','p_demo','1'),
	(30,98,'image','https://www.imageupload.net/upload-image/2019/12/31/9336383-1-navy.jpg','p_demo','1'),
...
INSERT INTO `middle` (`id`, `product_id`, `category_id`)
VALUES
	(1,1,1),
	(2,1,30),
	(3,2,1),
...
VALUES
	(1,'Heraldic','52','Black','silk','Feeling regal today? Showcasing the iconic Heraldic print and DG King embroidered logo','1938$','USA','https://www.imageupload.net/upload-image/2019/12/30/14090581_22480959_1000.jpg','1'),
	(2,'Distressed','44','Black','cotton','This season, Dolce & Gabbana explore the concept of luxe sportswear bringing a contemporary update to their much-loved ','703$','Italia','https://www.imageupload.net/upload-image/2019/12/30/14229690_20141914_1000.jpg','1'),
	(3,'Carnation Dressed','38','Black','polyamade','Multicolour silk-cotton blend carnation print midi dress from Dolce & Gabbana featuring a round neck, three-quarter length','1871$','Germany','https://www.imageupload.net/upload-image/2019/12/30/14516838_23027721_1000.png','1'),
	(4,'Mainyver Tops','39','White','cotton','Available in a range of styles to suit all','963$','USA','https://www.imageupload.net/upload-image/2019/12/30/12606171_12109880_1000-1.png','1'),
	(5,'Saffiano','30','Pink','Leather','Chiefs in leather craftsmanship, Prada\'s acclaimed Saffiano leather is consistently','833$','France','https://www.imageupload.net/upload-image/2019/12/30/13611915_22000685_1000.jpg','1'),
	(6,'Beige','36','Brown','Jersy','Relaxed-fit cotton-blend jersey lounge pants featuring logo pattern in beige and brown. Mid-rise','1500$','Germany','https://www.imageupload.net/upload-image/2019/12/31/gucci-beige-Beige-GG-Logo-Lounge-Pants.jpg','1'),
	(7,'BlackGG','37','Black','Cotton','Short sleeve cotton jersey t-shirt in black. Rib knit crewneck collar','480$','Italia','https://www.imageupload.net/upload-image/2019/12/31/BW70603Z0Y_F_GIV-001.fronte.jpg','1'),
	(8,'Christian','39','Black','Leather','High-top buffed calfskin sneakers in black. Round toe. Tonal lace-up closure.','1350$','France','https://www.imageupload.net/upload-image/2019/12/31/ezgif.com-webp-to-jpg.md.jpg','1'),
	(9,'Tarpered','35','Blue','Jeans','Jeans by Calvin Klein Jeans It\'s all the in jeans Mid-blue wash Regular rise Zip fly Functional','680$','Italia','https://www.imageupload.net/upload-image/2019/12/30/14229690_20141924_10004ef114e7778b2569.jpg','1'),
	(10,'PaddedJacket','37','Red','Cotton','Jacket by Calvin Klein Jeans Add it to your everyday line-up Padded for comfort Detachable','720$','USA','https://www.imageupload.net/upload-image/2019/12/30/12870974-1-racingred.jpg','1'),
	(11,'IronWhite','36','White','Cotton','Shirt by Calvin Klein It\'s a classic Spread collar Button placket Small logo detail to chest Skinny fit Cut very closely to the body Exclusive to ASOS','300$','VietNam','https://www.imageupload.net/upload-image/2019/12/30/11055311-1-dfwhite.jpg','1'),
	(12,'Grainy','15.25','Grey','Leather','Hugo Boss Crossbody. Barcode: 4021402639977','567$','Italia','https://www.imageupload.net/upload-image/2019/12/30/hugo-boss-men_s-medium-gray-crosstown-grainy-briefcase-50390384_030.jpg','1'),
	(13,'Sunglasses','55','Grey','Nilon','These authentic Boss by Hugo Boss Boss 1029/F/S Asian Fit 807/T4 sunglasses have Black Titanium frames and are available online for a discounted price at SmartBuyGlasses','300$','France','https://www.imageupload.net/upload-image/2019/12/31/716btntoj5L._UL1500_.jpg','1'),
	(14,'BurbberyKid','12','Brown','Cotton','A cotton shirt dress with contrasting panels in our Vintage check and Icon stripe.','240$','Russia','https://www.imageupload.net/upload-image/2019/12/30/14032866_18392426_1000.png','1'),
	(15,'BomberJacket','8','Blue','Lurex','Dark blue waterproof nylon satin. Yellow trims along the sleeves and pockets','1004$','Germany','https://www.imageupload.net/upload-image/2019/12/30/jackets-gucci.jpg','1'),
	(16,'Campagnolo','14','Red','Cotton','Kids ́ clothing Pants Cmp Salopette 14 Years. Length: Long, Color: Red, Features: Thermal, Features: Waterproof','219$','USA','https://www.imageupload.net/upload-image/2019/12/31/pmpl_29832_1.jpg','1'),
	(17,'Elision','35','Orange','Cotton','Fabric: Jersey - Face patch at breast - Solid-color design - T-shirt style - Waist-length style - Crew neck - Short sleeves - Shell: 100% cotton - Wash cold','233$','VietNam','https://www.imageupload.net/upload-image/2019/12/31/acne-studios-ellison-face-tshirt-paprika-red-face-patch-at-breast-solid-color-design-1069-500x500.jpg','1'),
	(18,'Twill Bomer','37','Purple','Cotton','Bomber jacket by Calvin Klein A fresh addition Baseball collar Zip opening Side pockets Fitted hem and cuffs Regular fit True to size','344$','USA','https://www.imageupload.net/upload-image/2019/12/31/13613105-1-navy.jpg','1'),
	(19,'Classic Teddy','XXL','Black','Cotton','Long sleeve wool-blend canvas bomber jacket in black. Rib knit stand collar, cuffs, and hem striped in white. Press-stud closure at front. Lambskin stripes in white at armscyes ...','564$','France','https://www.imageupload.net/upload-image/2019/12/31/201418M175002_1.jpg','1'),
	(20,'Climacool','M','Black','Sporty','Men ́s clothing Pants Adidas Design 2 Move Climacool 3 Stripes Knit Shorts Regular M. Length: Short, Recommended use: Multisport','122$','USA','https://www.imageupload.net/upload-image/2019/12/31/adidas-design-2-move-climacool-3-stripes-knit-shorts-regular.jpg','1'),
	(21,'Miki House','19','Red','Leather','Red faux leather My First shoes from MIKI HOUSE featuring a round toe, a touch strap fastening and a flat sole.','110$','USA','https://www.imageupload.net/upload-image/2019/12/31/13903653_17736912_1000.jpg','1'),
	(22,'Fleece','6','Pink','Cotton','The Barts Fleece Col Kids is made from soft fleece material and finished with a small Barts branding.','103$','Germany','https://www.imageupload.net/upload-image/2019/12/31/71VYxA3casL._UX679_.jpg','1'),
	(23,'Octagonal','56.18','Black','Metal','Octagonal metal-frame optical glasses in black and gold-tone. Transparent rubber nose pads. Logo plaque at hinges. Acetate temple tips featuring signature red and green stripes','286$','Italia','https://www.imageupload.net/upload-image/2019/12/31/9816402.jpg','1'),
	(24,'Frank Belt','M , S','Black','Leather','B-Low the Belt Frank Hip Belt in Black & Silver - Black. Size S (also in M). Genuine leather belt. Measures approx 1.5 H. Silver-tone metal buckle measures approx 2.75 H.','199$','Russia','https://www.imageupload.net/upload-image/2019/12/31/BLOW-WB30_V1-1.jpg','1'),
	(25,'Pharell','38, 39','White','Midsoles','Fabric: Knit\'Hu\' embroidery at vamp - Mesh trim - Intergrated cushioned tongues and pull tabs - Removable cushioned insoles - Boost foam midsoles and plastic side heel guards','399$','France','https://www.imageupload.net/upload-image/2019/12/31/Adidas_PU-9.jpg','1'),
	(26,'City Dragon','M','Black','Cotton','Short sleeve cotton jersey t-shirt in black. Distressing throughout. Rib knit crewneck collar. Multicolor graphic and text printed at front. Supplier color: Tar','544$','USA','https://www.imageupload.net/upload-image/2019/12/31/008_a41a66da-079c-431c-82c1-b7e13117e8d0.jpg','1'),
	(27,'Polo Ralhm','L , Xl','Grey','Cotton','Shirt by Polo Ralph Lauren A wardrobe staple Button-down collar Polo Ralph Lauren logo Button placket Slim fit A narrow cut that sits close to the body','127$','USA','https://www.imageupload.net/upload-image/2019/12/31/8994938-1-grey.jpg','1'),
	...
	(29,'Rado','30mm','Black','Plantinum','Black high-tech ceramic case and bracelet. Fixed black ceramic bezel. Black dial with luminous gold-tone hands. Diamonds mark the 3, 6, 9 and 12 o\'clock positions. Dial Type: Analog. Luminescent hands','999$','Switzerland','https://www.imageupload.net/upload-image/2019/12/31/411H6t6lNgL._UY445_.jpg','1'),
	(30,'Asos','L','Blue','Cotton','Tall dress by ASOS DESIGN For that thing you have to go to One-shoulder design Tulle underskirt Zip with hook-and-eye fastening Regular cut Fits you just right','313$','France','https://www.imageupload.net/upload-image/2019/12/31/9336383-1-navy.jpg','1');
